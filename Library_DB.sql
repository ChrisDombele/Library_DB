...
-- CONSTRAINT Staff_FK1 FOREIGN KEY (Staff_ID) REFERENCES Staff_t(Staff_ID),
CONSTRAINT Staff_FK2 FOREIGN KEY (Book_ID) REFERENCES Book(Book_ID)
);
...
CONSTRAINT Study_Room_FK FOREIGN KEY (Student_ID) REFERENCES Student_t(Student_ID)
);
...
CONSTRAINT Staff_ID_2_FK FOREIGN KEY (Event_ID) REFERENCES Event(Event_ID)
);
...
CONSTRAINT Staff_ID_1_FK FOREIGN KEY (Media_ID) REFERENCES Media(Media_ID)
);
...
CONSTRAINT Staff_ID_0_FK FOREIGN KEY (Student_ID) REFERENCES Student(Student_ID)
);
